...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8c4cdaaa-b6b4-4285-8597-835234c53647
```

> `8c4cdaaa-b6b4-4285-8597-835234c53647` is the password of the certificate, you can change it to any password you want.
